...
namespace FakeTerminal
{
    ...
    public class Draw
    {
        ...
        public static void Text(string text, Vector2 position, Color color, Vector2 origin, Vector2 scale, float rotation)
        {
            Draw.SpriteBatch.DrawString(Font, text, Calc.Floor(position), color, rotation, origin, scale, SpriteEffects.None, 0);
        }

        public static void TextJustified(string text, Vector2 position, Color color, Vector2 justify)
        {
        ...
        public static void TextJustified(string text, Vector2 position, Color color, float scale, Vector2 justify)
        {
            Vector2 origin = Font.MeasureString(text);
            origin.X *= justify.X;
            origin.Y *= justify.Y;
        ...
        {
            Text(text, position - font.MeasureString(text) * .5f, Color.White);
        }
        ...
        {
            Text(text, position, color, font.MeasureString(text) * .5f, Vector2.One * scale, 0);
        }

        public static void TextCentered(SpriteFont font, string text, Vector2 position, Color color, float scale, float rotation)
        {
            Text(text, position, color, font.MeasureString(text) * .5f, Vector2.One * scale, rotation);
        }
